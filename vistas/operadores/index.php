...
<?php } ?>
    <div class="row">
      ...
      <div class="modal-footer">
       <button id="btnNuevo" type="button" class="btn btn-success" data-toggle="modal" data-target="#modalCRUD">Agregar operador</button>
      </div>  
        </div>
    </div>
</div>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <select id="rol" name="rol" class="form-control">
                        ...
                        <option value="1">Activar operador</option>
                    </select>
                    </div>
